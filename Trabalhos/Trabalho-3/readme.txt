...
Trabalho_3.cpp: Código fonte do programa de otimização.
...
all: Compila o executável Trabalho_3.
Trabalho_3: Linka o objeto compilado para criar o executável.
Trabalho_3.o: Compila o arquivo fonte Trabalho_3.cpp para um objeto.
clean: Remove os arquivos gerados (Trabalho_3 e Trabalho_3.o).