...
Trabalho_2.cpp: Código fonte do programa de otimização.
...
all: Compila o executável Trabalho_2.
Trabalho_2: Linka o objeto compilado para criar o executável.
Trabalho_2.o: Compila o arquivo fonte Trabalho_2.cpp para um objeto.
clean: Remove os arquivos gerados (Trabalho_2 e Trabalho_2.o).